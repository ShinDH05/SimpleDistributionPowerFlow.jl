...
def results(display_summary: bool, timestamp: bool):
    ...
    # ploss 컬럼들을 float형으로 일괄 변환
    lineflow[['ploss_ph1', 'ploss_ph2', 'ploss_ph3']] = lineflow[['ploss_ph1', 'ploss_ph2', 'ploss_ph3']].apply(
    ...
    # qloss 컬럼들을 float형으로 일괄 변환
    lineflow[['qloss_ph1', 'qloss_ph2', 'qloss_ph3']] = lineflow[['qloss_ph1', 'qloss_ph2', 'qloss_ph3']].apply(
        pd.to_numeric, errors='coerce')
